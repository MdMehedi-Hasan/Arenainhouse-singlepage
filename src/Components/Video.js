    ...
    return (
        <section className="bg-image text-white h-screen flex items-center"> {/* bg-image text-white */}
            ...
            <div className='container mx-auto grid grid-cols-2 justify-between items-center gap-x-20'>
                ...
                {/* <img src={test} alt=""/> */}
                <div className=''>
                    <h1 className="font-['Yeseva_One'] text-4xl">Cyber Security & Ethical Hacking</h1> {/* data-aos="zoom-in" data-aos-delay="0" data-aos-duration="3000" */}
                    <h3 className="font-['Yeseva_One'] text-xl mt-7 mb-5">Key Topics</h3> {/* data-aos="fade-right" data-aos-delay="100" data-aos-duration="3000" */} {/* data-aos="zoom-in" data-aos-delay="100" data-aos-duration="3000" */}
