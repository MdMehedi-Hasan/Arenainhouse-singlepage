        ...
        <section className="bg-image text-white h-max flex items-center py-20"> {/* bg-image text-white */}
            ...
            <div className='container mx-auto grid grid-cols-2 justify-between items-center gap-x-20'>
                <div data-aos="fade-right" data-aos-delay="100" data-aos-duration="3000" className='relative'>
                    ...
                    <embed width='100%' height='410px' src="https://www.youtube.com/v/u31L2FFKwGw&autoplay=1&mute=1" type="application/x-shockwave-flash" wmode="transparent" autoPlay></embed>
                </div>
                <div className=''>
                    <h1 className="text-6xl font-['Ubuntu'] font-bold text-white">Cyber Security & Ethical Hacking <sub className='text-md'>(Bundle Course)</sub></h1> {/* data-aos="zoom-in" data-aos-delay="0" data-aos-duration="3000" */}
                    <h3 className="text-xl mt-7 mb-5 font-['Tiro_Telugu']">Key Topics</h3> {/* data-aos="fade-right" data-aos-delay="100" data-aos-duration="3000" */} {/* data-aos="zoom-in" data-aos-delay="100" data-aos-duration="3000" */}
