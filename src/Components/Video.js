        ...
        <section className="py-32 bg-image text-white h-screen flex items-center"> {/* bg-image text-white */}
            {/* <Parallax className='mx-auto' speed={-50}> */}
                <div className='container mx-auto grid grid-cols-2 justify-between items-center gap-x-20'>
                    <div>
                    <video data-aos="fade-right" data-aos-delay="100" data-aos-duration="3000" className='' controls autoPlay>
                    ...
                    {/* <img src={test} alt=""/> */}
                    <div className=''>
                        <h1 data-aos="zoom-in" data-aos-delay="0" data-aos-duration="3000" className="font-['Yeseva_One'] text-7xl">Arena Web Security</h1>
                        <h3 data-aos="fade-right" data-aos-delay="100" data-aos-duration="3000" className="font-['Dancing_Script'] text-3xl">New Window of World Wide Web</h3>
                        <p data-aos="zoom-in" data-aos-delay="100" data-aos-duration="3000" className="font-['Cormorant_Garamond'] text-2xl mt-10 text-justify">Arena Web Security is a sister concern of Arena Web Technology. Arena Web Security is a renowned IT security company in Bangladesh since its establishment in 2012. During these years, Arena Web Security has provided Cyber Security Services and Trainings to many around the world. <br /> <br />
